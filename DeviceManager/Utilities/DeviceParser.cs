...
class DeviceParser
{
     ...
     public static PersonalComputer ParsePC(string line, int lineNumber)
     {
     ...
     public static Smartwatch ParseSmartwatch(string line, int lineNumber)
     {
    ...
    public static Embedded ParseEmbedded(string line, int lineNumber)
    {
